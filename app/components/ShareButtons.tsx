...
export function ShareButtons({
  ...
  const copyThenOpen = async (destination: string) => {
    await copyLink();
  ...
  const apps: App[] = [
    ...
    },
    {
      ...
      onClick: () =>
        openPopup(`fb-messenger://share?link=${encodeURIComponent(pageUrl())}`),
    },
    {
      name: 'Facebook',
      icon: (
    ...
    },
    {
      ...
      onClick: () => copyThenOpen('https://www.instagram.com/direct/inbox/'),
    },
    {
      name: 'TikTok',
      icon: (
      ...
      onClick: () => copyThenOpen('https://www.tiktok.com/messages'),
    },
  ];
